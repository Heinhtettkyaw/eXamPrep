...
@section('content')
    @if (session('resetSuccess'))
        <div id="alert-additional-content-1"
            ...
            <div class="flex items-center">
                ...
                <h3 class="text-lg font-medium">Reset {{ session('name') }}'s password successfully !!!</h3>
            </div>
            <div class="mt-2 mb-4 text-sm">
                Default password after resetting password is 'student123' with all small alphabets.
            </div>
            <div class="flex">
    ...
    @endif
    {{-- Desktop version --}}
    <main class="hidden md:block h-full pb-16 px-16 overflow-y-auto">
                                ...
                                <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center space-x-4 text-sm">
                                            <a href="{{ route('admin#loadStudentEdit', $student['id']) }}">
                                                <button
                                            ...
                                            <a href="{{ route('admin#resetPassword', $student['id']) }}">
                                                <button
                                                    class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-blue-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                                                    aria-label="Password">
                                                    <svg class="w-5 h-5" aria-hidden="true" fill="currentColor"
                                            ...
                                            <a href="{{ route('admin#studentDelete', $student['id']) }}">
                                                <button
                                                    class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-blue-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                                                    aria-label="Delete">
                                                    <svg class="w-5 h-5" aria-hidden="true" fill="currentColor"
    ...
    <main class="md:hidden">
        <div>
            <ol class="p-2 inline-flex items-center space-x-1">
                <li class="inline-flex items-center">
                    <a href="{{ route('admin#dashboard') }}"
                        class="inline-flex items-center text-lg font-semibold text-blue-500bg-gray-800 hover:text-gray-700 dark:text-gray-400 dark:hover:text-white">
                        Dashboard
                    </a>
                </li>
                <li>
                    <div class="flex items-center text-lg text-gray-600 dark:text-blue-500">
                        ...
                        <a href="#"
                            class="ml-1 font-semibold text-blue-500 hover:text-gray-700 md:ml-2 dark:text-gray-400 dark:hover:text-white">Students</a>
                    </div>
                </li>
            </ol>
        </div>
        <div class="flex justify-center mt-4 mb-5">
            <a href="{{ route('admin#addStudent') }}" class="mx-4 shadow-md">
                <button
                    class="flex items-center justify-between px-4 py-2 text-lg shadow-md border-b-2 border-gray-600 font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue">
                    Add Student
                </button>
        ...
        <div class="flex mx-3 mt-3 mb-2">
            <form class="flex-grow" action="{{ route('admin#showStudents') }}" method="get">
                <div class=" flex gap-2 items-center">
                    <input name="searchKey"
                        class="flex-grow  rounded-lg text-lg bg-blue-50 dark:bg-gray-600 dark:text-white dark:placeholder-white"
                        type="search" placeholder="Search Student" value="{{ request('searchKey') }}" />
                    <button class="bg-blue-600 text-white border border-gray-600 p-3 rounded-lg" type="submit"><svg
        ...
        <div class="flex">
            <table class="grow mx-3 mt-3 text-lg bg-blue-50 dark:bg-gray-600 dark:text-gray-300 text-left overflow-y-auto">
                <thead class="font-semibold bg-blue-100 dark:text-gray-400 dark:bg-gray-800">
                    <tr>
