      ...
      <div class="flex items-center justify-between">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3 text-xs">
          ...
          <li>
            <div class="flex items-center">
              <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
              <a href="results.html" class="ml-1 font-semibold text-gray-500 hover:text-gray-700 md:ml-2 dark:text-gray-400 dark:hover:text-white">Results Details</a>
            </div>
          </li>
          <li aria-current="page">
            <div class="flex items-center">
              ...
              <span class="ml-1 font-semibold text-gray-700 md:ml-2 dark:text-gray-400">View Results</span>
            </div>
          </li>
        </ol>
      </div>
