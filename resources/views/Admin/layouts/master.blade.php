...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('Admin/assets/img/goldenTKM.png') }}" rel="icon">
                ...
                <ul>
                    <li class="relative px-6 py-3">
                        ...
                        <a class="inline-flex items-center w-full text-sm font-semibold  transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 "
                            ...
                            <span class="ml-4">Exam</span>
                        </a>
                    </li>

                    <li class="relative px-6 py-3">
                        @yield('activeResultSummary')
                        <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                            href="ExamResultSummary.html">
                            <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round"
                                stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                                <path d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"></path>
                                <path d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"></path>
                            </svg>
                            <span class="ml-4">Exam Result Summary</span>
                        </a>
                    </li>
                    ...
                    <li class="relative px-6 py-3">
                        ...
                        <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                            ...
                            <span class="ml-4">Exam Results</span>
                        </a>
                    </li>
                    <li class="relative px-6 py-3">
                        @yield('activeQB')
                        <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                            href="{{ route('Admin#showQB') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M20.25 6.375c0 2.278-3.694 4.125-8.25 4.125S3.75 8.653 3.75 6.375m16.5 0c0-2.278-3.694-4.125-8.25-4.125S3.75 4.097 3.75 6.375m16.5 0v11.25c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125V6.375m16.5 0v3.75m-16.5-3.75v3.75m16.5 0v3.75C20.25 16.153 16.556 18 12 18s-8.25-1.847-8.25-4.125v-3.75m16.5 0c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125" />
                            </svg>
                            <span class="ml-4">Questions Bank</span>
                        </a>
                    </li>
                </ul>
            </div>
                        ...
                        <li class="relative">
                            <button class="align-middle rounded-full focus:shadow-outline-blue focus:outline-none"
                                ...
                                @if (Auth::user()->image == null)
                                    <img class="object-cover w-8 h-8 rounded-full"
                                        src="{{ asset('image/default_profile.jpg') }}" alt=""
                                        aria-hidden="true" />
                                @else
                                    <img class="object-cover w-8 h-8 rounded-full"
                            ...
                            <template x-if="isProfileMenuOpen">
                                <ul x-transition:leave="transition ease-in duration-150"
                                    ...
                                    <li class="flex">
                                        <button type="button"
                                            class="relative inline-flex items-center justify-start w-full px-4 py-2 text-sm font-medium border-b border-gray-200 rounded-t-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:border-gray-600 dark:hover:bg-gray-600 dark:hover:text-white dark:focus:ring-gray-500 dark:focus:text-white">
                                            <a href="{{ route('admin#showProfile') }}"
                                                class="relative inline-flex items-center justify-start">
